...
public class Listing {
    @SerializedName("bathrooms") @Expose private Double bathrooms;
    @SerializedName("bedrooms") @Expose private Integer bedrooms;
    @SerializedName("beds") @Expose private Integer beds;
    @SerializedName("city") @Expose private String city;
    @SerializedName("extra_host_languages") @Expose private List<String> extraHostLanguages = new ArrayList<String>();
    @SerializedName("id") @Expose private Integer id;
    @SerializedName("instant_bookable") @Expose private Boolean instantBookable;
    @SerializedName("is_business_travel_ready") @Expose private Boolean isBusinessTravelReady;
    @SerializedName("is_family_preferred") @Expose private Boolean isFamilyPreferred;
    @SerializedName("is_new_listing") @Expose private Boolean isNewListing;
    @SerializedName("lat") @Expose private Double lat;
    @SerializedName("lng") @Expose private Double lng;
    @SerializedName("localized_city") @Expose private String localizedCity;
    @SerializedName("name") @Expose private String name;
    @SerializedName("neighborhood") @Expose private String neighborhood;
    @SerializedName("person_capacity") @Expose private Integer personCapacity;
    @SerializedName("picture_count") @Expose private Integer pictureCount;
    @SerializedName("picture_url") @Expose private String pictureUrl;
    @SerializedName("primary_host") @Expose private PrimaryHost primaryHost;
    @SerializedName("property_type_id") @Expose private Integer propertyTypeId;
    @SerializedName("property_type") @Expose private String propertyType;
    @SerializedName("public_address") @Expose private String publicAddress;
    @SerializedName("reviews_count") @Expose private Integer reviewsCount;
    @SerializedName("room_type_category") @Expose private String roomTypeCategory;
    @SerializedName("room_type") @Expose private String roomType;
    @SerializedName("scrim_color") @Expose private String scrimColor;
    @SerializedName("space_type") @Expose private String spaceType;
    @SerializedName("star_rating") @Expose private Double starRating;
    ...
    @SerializedName("xl_picture_url") @Expose private String xlPictureUrl;
    @SerializedName("preview_encoded_png") @Expose private String previewEncodedPng;
    @SerializedName("picture_urls") @Expose private List<String> pictureUrls = new ArrayList<String>();
    @SerializedName("xl_picture_urls") @Expose private List<String> xlPictureUrls = new ArrayList<String>();
    ...
    public void setIsBusinessTravelReady(Boolean isBusinessTravelReady) { this.isBusinessTravelReady = isBusinessTravelReady; }
