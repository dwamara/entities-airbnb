...
public class Metadata {
    ...
    @Expose
    private List<Object> listingCardsUrgencyCommitmentMetadata = new ArrayList<Object>();
    @SerializedName("listing_cards_price_line_urgency_commitment_metadata")
    @Expose
    private List<Object> listingCardsPriceLineUrgencyCommitmentMetadata = new ArrayList<Object>();
