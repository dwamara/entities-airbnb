...
public class User_ {
    ...
    @SerializedName("about") @Expose private String about;
    @SerializedName("first_name") @Expose private String firstName;
    @SerializedName("has_completed_ib_salmon_flow_v2") @Expose private Boolean hasCompletedIbSalmonFlowV2;
    @SerializedName("has_dismissed_ib_salmon_flow") @Expose private Boolean hasDismissedIbSalmonFlow;
    @SerializedName("has_dismissed_ib_salmon_flow_v2") @Expose private Boolean hasDismissedIbSalmonFlowV2;
    @SerializedName("has_profile_pic") @Expose private Boolean hasProfilePic;
    @SerializedName("ib_salmon_flow_data") @Expose private List<Object> ibSalmonFlowData = null;
    @SerializedName("id") @Expose private Integer id;
    @SerializedName("identity_verified") @Expose private Boolean identityVerified;
    @SerializedName("is_active_rtb_host") @Expose private Boolean isActiveRtbHost;
    @SerializedName("is_superhost") @Expose private Boolean isSuperhost;
    @SerializedName("languages") @Expose private List<Object> languages = null;
    @SerializedName("picture_url") @Expose private String pictureUrl;
    @SerializedName("reviewee_count") @Expose private Integer revieweeCount;
